...
class ProblemsTest extends FunSuite {
  ...
  test("problem 20 - recursive function") {
    ...
    assertThrows[IndexOutOfBoundsException](removeAtFunc(4, List('a, 'b, 'c, 'd)))
    assertThrows[IndexOutOfBoundsException](removeAtFunc(-1, List('a, 'b, 'c, 'd)))
  }
  ...
  test("problem 20 - higher-order functions") {
    ...
    assertThrows[IndexOutOfBoundsException](removeAt(4, List('a, 'b, 'c, 'd)))
    assertThrows[IndexOutOfBoundsException](removeAt(-1, List('a, 'b, 'c, 'd)))
  }
  ...
  test("problem 21 - recursive function") {
    ...
    assertThrows[IndexOutOfBoundsException](insertAtFunc('x, 5, List('a, 'b, 'c, 'd)))
    assertThrows[IndexOutOfBoundsException](insertAtFunc('x, -1, List('a, 'b, 'c, 'd)))
  }
  ...
  test("problem 21 - higher-order functions") {
    ...
    assertThrows[IndexOutOfBoundsException](insertAt('x, 5, List('a, 'b, 'c, 'd)))
    assertThrows[IndexOutOfBoundsException](insertAt('x, -1, List('a, 'b, 'c, 'd)))
  }

  test("problem 22 - recursive function") {
    assert(rangeFunc(3, 7) === List(3, 4, 5, 6, 7))
    assert(rangeFunc(3, 3) === List(3))
    assert(rangeFunc(8, 7) === List())
  }

  test("problem 22 - higher-order functions") {
    assert(range(3, 7) === List(3, 4, 5, 6, 7))
    assert(range(3, 3) === List(3))
    assert(range(8, 7) === List())
  }
}
